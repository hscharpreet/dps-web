  ...
  return (
    <>
      <div className="messageContainer">
          ...
          <div className="parah">
          <h1 className="heading"><span className="line1"></span>  PRINCIPAL'S MESSAGE   </h1>
            <p>
              ...
              knowledge and competence. <br /> I shall endeavor to ensure that students
              of Samaritan Mission School (High) pursue their dreams in a safe,
              secure, and healthy environment. My heartful thanks to Founder
              Secretary Shri Mamoon Akhtar under whose stewardship the school
              has progressed in leaps and bounds. I also would like to thank the
              past and present management, parents, and students for their
